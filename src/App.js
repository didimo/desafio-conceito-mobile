...
export default function App() {
  ...
  async function handleLikeRepository(id) {
    ...
    const indexRepository = repositoriesClone.findIndex(repository => repository.id = id);
    repositoriesClone[indexRepository].likes = likes;
    console.log(repositoriesClone);
